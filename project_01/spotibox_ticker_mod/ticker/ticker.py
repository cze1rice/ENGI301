...
class Ticker():
    ...
    def __init__(self, widgets, matrix_pins, button_pins, light_pins, brightness=6, refresh_rate=20, verbose=False):
...
if __name__ == '__main__':
    ...
    ticker = Ticker(widgets, matrix_pins, button_pins, light_pins, brightness=6, refresh_rate=10, verbose=False)
    ticker.setup()
    ticker.run()
